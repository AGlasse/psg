...
class PSG_model:
    ...
    def make_run_config_file(base_config_file, **kwargs):
        ...
        config_file = PSG_model.run_config_file
        config_path = data_dir + PSG_model.run_config_file
        os.chdir(data_dir)
    ...
    def load_spectrum(pickle_path, **kwargs):
        ...
        rad_spectrum = PSG_model._load_pickle(pickle_path)
        flux_spectrum = Globals.convert_radiance_to_flux(rad_spectrum)
        PSG_model.rad_spectrum, PSG_model.flux_spectrum = rad_spectrum, flux_spectrum
